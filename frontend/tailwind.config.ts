	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { boxShadow: '0 0 5px hsl(var(--amber-warm) / 0.5)' },
					'50%': { boxShadow: '0 0 20px hsl(var(--amber-warm) / 0.8)' }
				},
				'pulse-glow': {
			...
			animation: {
				...
				'delayed-slide-up': 'slide-up 0.8s ease-out 0.4s both',
			},
			backgroundImage: {
